    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
           ...
           <div class="row">
            ...
            <%--MODAL DE AVISO--%>
            <asp:UpdatePanel ID="upPedidoAviso" runat="server" Visible="true">    
                <ContentTemplate>
                    <div id="modalPedidoAviso" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalLblPedAviso" aria-hidden="true" >                              
                        <div class="modal-dialog" role="document">                                
                            <div class="modal-content">                                  
                                <div class="modal-header">                                    
                                    <center><h3 class="modal-title" id="modalLblPedAviso">Aviso del Pedido</h3></center> 
                                ...
                                <div class="modal-body">                                                                                                                                                                                                                                                                     
                                    <div class="form-group">                                          
                                        <asp:Label ID="lblAvisoPedido" runat="server"><h4><strong>Su pedido fue registrado exitosamente para ser procesado y autorizado. <br /> 
                                            Una vez aprobado, genere su TOKEN para recogerlo.<br /></strong></h4>
                                            Este módulo se encuentra en: PEDIDOS -> <a href="ALM_TOK_GenerarToken.aspx" role="button" class="btn btn-info" >GENERAR TOKEN</a><br /> 
                                            Luego presione el boton "Generar".
                                        </asp:Label>                                          
                                    </div>                                                                                                                                          
                                </div>                                                                      

<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Principal.Master" AutoEventWireup="true" CodeBehind="PED_Autorizar.aspx.cs" Inherits="SistemaAlmacenesWeb.Forms.PED_Autorizar" %>
                                                ...
                                                <div class="form-group">
                                                    <asp:GridView ID="gvDatos1" runat="server" CssClass="table table-striped table-bordered table-hover input-sm" AutoGenerateColumns="False" PageSize="15" OnRowCommand="gvDatos1_RowCommand" >
                                                        <Columns>
                                                            ...
                                                            <asp:ButtonField HeaderText="" ButtonType="Button" Text="Modificar" >
